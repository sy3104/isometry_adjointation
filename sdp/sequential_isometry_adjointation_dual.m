% -------------------------------------------------------------------------
%
% File: sequential_isometry_adjointation_dual.m
%
% Description :
...
function opt_fom = sequential_isometry_adjointation_dual(din,dout,n,task,isComplex)
...
trace(WW{1}{1}{1}) + trace(WW{1}{1}{2}) == p*din;
